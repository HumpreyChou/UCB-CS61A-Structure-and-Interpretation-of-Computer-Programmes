...
# @Date:   2021-01-22 22:34:09
# @Last Modified by:   Xia Hanyu (Humprey Chou)
# @Last Modified time: 2021-01-22 23:50:15
...
class VendingMachine:
    ...
    def vend(self):
        ...
        self.balance = 0
        return 'Here is your {0}.'.format(self.product) if remain == 0 else 'Here is your {0} and ${1} change.'.format(self.product, remain)
...
def is_bst(t):
    ...
    if len(t.branches) == 1:
        ...
        l, r = t.branches
        return is_bst(l) and is_bst(r) and (bst_max(l) <= t.label < bst_min(r))
    else:
        return False
